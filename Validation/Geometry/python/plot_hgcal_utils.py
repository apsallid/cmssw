...
_LABELS2COMPS = {'BeamPipe': 'BEAM',
                 ...
                 #'FromVertexToBackOfHGCal' : ['BeamPipe','Tracker','ECAL','HCal','EndcapTimingLayer + Thermal Screen','Neutron Moderator + Thermal Screen','HGCal + HGCal Service + Thermal Screen', 'Solenoid Magnet', 'Muon Wheels and Cables'],
...
COMPOUNDS["TrackerSumPhaseII"] = ["BeamPipe",
                                  ...
                                  "Phase2PixelEndcap"]
COMPOUNDS["CALO"] = ["CALO"]
COMPOUNDS["CALOECTSFront"] = ["CALOECTSFront"]
...
COMPOUNDS["From Vertex To Muon Station"] = ["FromVertexToBackOfHGCal"]
#COMPOUNDS["FromVertexToBackOfHGCal"] = ["BeamPipe","Tracker","ECAL","HCal","Solenoid Magnet"]
...
DETECTORS["CALOECTSFront"] = kOrange+5
'''
DETECTORS["BeamPipe"] = kGray+2
